...
int main(void)
{
    ...
    //Las variables ademas pueden tener 4 tipos, auto, static, register y extern
    // auto -> por defecto todas la son y solo son visibles dentro del bloque está definida.
    // static -> iguales a las auto, pero su existencia es permanente.
    // register -> Le recomienda al compilador que guarde permanentemente la variable
    // extern -> referencia una variable global anteriormente deinida.
    return 0;
}
